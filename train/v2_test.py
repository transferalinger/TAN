"""
File: train/v2_test.py
 - Contain training code for execution for mlp and transfer normalization layer on top of autoencoder model.
"""
import sys
sys.path.append("..")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--matchnet_path', default='', type=str, help='path of aligner')
    ...
    matchnet_path = args.matchnet_path
