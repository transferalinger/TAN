"""
File: train/ae_train.py
 - Contain training code for execution for autoencoder model.
"""
import sys
sys.path.append("..")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--display_step', default='', type=int, help='data index')
    ...
    ae.learn(test_d, display_step, early_stop, device)
